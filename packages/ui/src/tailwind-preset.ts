  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        /**
         * 홈의 놀이터 이름에만 쓰는 둥근 글씨(Jua).
         *
         * 본문에는 쓰지 않는다 — 둥근 글꼴은 ㄹ·ㅁ·ㅂ 이 서로 비슷해져 글자
         * 모양을 배우는 아이에게 방해가 된다. 여기는 **배우는 글자가 아니라
         * 자리 이름**이고, 영숙님이 만든 그림 속 글씨와 결이 같아야 한 벌로
         * 보인다. 글자 굵기가 하나뿐이라 굵게(bold)를 걸지 않는다.
         */
        title: ['Jua', '"Nanum Gothic"', 'sans-serif'],
