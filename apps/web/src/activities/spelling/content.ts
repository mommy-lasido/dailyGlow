 ...
 * 맞춤법 탐험대 자료.
 *
 * 영숙님이 직접 만든 예전 앱(`files_라윤/index.html`)의 문항을 그대로 옮겼다.
 * 101개 항목, 빈칸 문장 202개. 손으로 다듬은 자료라 새로 만들지 말고 여기를 고쳐 쓸 것.
 *
...
export const SPELLING_ITEMS: SpellingItem[] = [
    ...
    options: [
      {
        text: "으로서",
        correct: true,
        note: "신분이나 자격을 말할 땐 '으로서'를 써요."
      },
      {
        text: "으로써",
        correct: false,
        note: "'으로써'는 방법이나 도구를 말할 때 쓰는 말이에요."
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "삭이며",
        correct: true,
        note: "화나 감정을 가라앉힐 땐 '삭이다'를 써요."
      },
      {
        text: "삭히며",
        correct: false,
        note: "'삭히다'는 음식을 발효시킬 때 쓰는 말이에요. (김치를 삭히다)"
      }
    ]
  },
  {
  ...
  {
    // 원래는 "사장님 결재", "팀장님의 결재" 처럼 회사에서 쓰는 문장이었다.
    // 초등학생이 겪어 본 적 없는 장면이라 뜻을 알아도 답을 고를 수가 없다.
    // 물건값을 내는 '결제' 쪽만 물어본다.
    templates: [
      "엄마가 카드로 물건값을 ___했어요.",
    ...
    options: [
      {
        text: "되뇌었어요",
        correct: true,
        note: "기본형이 '되뇌다'라서 '되뇌었어요'로 써요."
      },
      {
        text: "되뇌였어요",
        correct: false,
        note: "'되뇌이다'는 잘못된 표기예요."
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "예삿일",
        correct: true,
        note: "'예사'와 '일'이 합쳐질 때 사이시옷이 들어가 '예삿일'로 써요."
      },
      {
        text: "예사일",
        correct: false,
