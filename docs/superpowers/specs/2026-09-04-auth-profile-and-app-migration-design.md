...
| 시윤 | 2021년생 | 유치원 (한글 4단계) | 자음모음 배우기·낱말 읽기, 쓰기 학습지, 더하기 |
| 정도윤 (남) | 2023-08-02 | 미취학 (한글 1단계부터) | 자음모음 배우기 |
...
| `letter_cards` | 자음모음 배우기 | 런타임 (단계별 자모 조합) |
| `word_cards` | 낱말 읽기 | DB |
...
| 활동 | 시작 단계 | 내용 |
|---|---|---|
| 🔤 자음모음 배우기 (`letter_cards`) | 1단계 | "가 갸 거 겨" 음절 카드. 톡 누르면 🔊. **도윤이가 여기서 시작** |
